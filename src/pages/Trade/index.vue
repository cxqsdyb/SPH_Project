  ...
  <div class="trade-container">
    ...
    <div class="trade">
      ...
      <div class="receiveInfo">
        寄送至:
        <span>{{ defaultInfo.fullAddress }}</span>
        收货人：<span>{{ defaultInfo.consignee }}</span>
        <span>{{ defaultInfo.phoneNum }}</span>
      </div>
    </div>
...
export default {
  ...
  methods: {
    ...
    async submitOrder() {
      ...
      let userData = {
        consignee: this.defaultInfo.consignee,
        consigneeTel: this.defaultInfo.phoneNum,
        deliveryAddress: this.defaultInfo.fullAddress,
        paymentWay: "ONLINE",
      ...
      // 发送请求，请求在vue原型上：$API
      let result = await this.$API.reqSubmitOrder(tradeNo, userData);
