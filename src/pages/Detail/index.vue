        ...
        <div class="InfoWrap">
          ...
          <div class="choose">
            <div class="chooseArea">
              ...
              <dl
                v-for="skuItem in spuSaleAttrList"
                :key="skuItem.baseSaleAttrId"
              >
                <dt class="title">{{ skuItem.saleAttrName }}</dt>
                <dd
                  v-for="item in skuItem.spuSaleAttrValueList"
                  :key="item.id"
                  :class="{ active: item.isChecked == 1 }"
                  @click="changeActive(item, skuItem.spuSaleAttrValueList)"
                >
            ...
            <div class="cartWrap">
              <div class="controls">
                ...
                <a
                  href="javascript:"
                  class="plus"
                  @click="skuNum < 99 ? (skuNum += 1) : (skuNum += 0)"
                  >+</a
                >
                <a
                  href="javascript:"
                  class="mins"
                  @click="skuNum > 1 ? (skuNum -= 1) : (skuNum = 1)"
                  >-</a
                >
              </div>
              <div class="add">
  ...
  methods: {
    ...
    chengeSkuNum(event) {
      ...
      if (isNaN(value) || value < 1) {
        ...
        this.skuNum = Math.min(parseInt(value), 99);
      }
    },
    async addShopCart() {
      // mounted中有商品id！
      let sendData = { skuId: this.$route.params.goodsId, skuNum: this.skuNum + '' };
