      ...
      <div class="title clearfix">
        ...
        <div class="fr">
          <ul class="nav-tabs clearfix">
            <li
              class="active"
              v-for="(nav, index) in floorData.navList"
              :key="index"
            >
      ...
      <div class="tab-content">
        <div class="tab-pane">
          <div class="floor-1">
            <div class="blockgary">
              <ul class="jd-list">
                <li v-for="(word, index) in floorData.keywords" :key="index">
                  {{ word }}
                </li>
              </ul>
            ...
            <div class="floorBanner">
              <!-- 轮播图 -->
              <MyCarouse :Data="floorData.carouselList" />
            </div>
            <div class="split">
...
<script>
// import MyCarouse from '@/components/Carouse'
export default {
  name: 'MyFloor',
  props: ['floorData'],
  // components: {
